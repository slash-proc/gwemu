...
/*
 * xemu's GamesPopupMenu scanned games_dir for .iso/.xiso disc images and
 * loaded them via ActionLoadDiscFile() -- both dropped (see actions.cc).
 * gnw-h7b0's equivalent "pick what to run" concept (stock/CFW firmware
 * banks, SD content) is a real future menu, not a drop-in disc browser --
 * deferred to a later phase, not stubbed here.
 */
