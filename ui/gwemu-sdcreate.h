 ...
 * worker) -- takes the BQL internally around all block-layer work; see
 * the .c file for the rationale. Do NOT call while already holding the
 * BQL (e.g. from the main loop / an ImGui handler).
 *
