...
- Device model: `hw/misc/gnw_h7b0_wwdg.c`
- Register header: `include/hw/misc/gnw_h7b0_regs_wwdg.h` (layout: regs_generated)

| Register | Offset | Write | Read | Notes (line ref / snippet) |
|---|---|---|---|---|
| GNW_H7B0_WWDG_CR | 0x0 | shadow | shadow |  |
| GNW_H7B0_WWDG_CFR | 0x4 | shadow | shadow |  |
| GNW_H7B0_WWDG_SR | 0x8 | shadow | shadow |  |
