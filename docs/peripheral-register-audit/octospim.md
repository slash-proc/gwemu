...
- Device model: `hw/misc/gnw_h7b0_octospim.c`
- Register header: `include/hw/misc/gnw_h7b0_regs_octospim.h` (layout: regs_generated)

| Register | Offset | Write | Read | Notes (line ref / snippet) |
|---|---|---|---|---|
| GNW_H7B0_OCTOSPII_O_MANAGER_CR | 0x0 | shadow | shadow |  |
| GNW_H7B0_OCTOSPII_O_MANAGER_P1CR | 0x4 | shadow | shadow |  |
| GNW_H7B0_OCTOSPII_O_MANAGER_P2CR | 0x8 | shadow | shadow |  |

Summary: 3 registers found. Write: 0 explicit / 3 shadow. Read: 0 explicit / 3 shadow.
