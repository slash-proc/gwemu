...
- Device model: `hw/misc/gnw_h7b0_syscfg.c`
- Register header: `include/hw/misc/gnw_h7b0_regs_syscfg.h` (layout: regs_generated)

| Register | Offset | Write | Read | Notes (line ref / snippet) |
|---|---|---|---|---|
| GNW_H7B0_SYSCFG_PMCR | 0x4 | shadow | shadow |  |
| GNW_H7B0_SYSCFG_EXTICR1 | 0x8 | shadow | shadow |  |
| GNW_H7B0_SYSCFG_EXTICR2 | 0xc | shadow | shadow |  |
| GNW_H7B0_SYSCFG_EXTICR3 | 0x10 | shadow | shadow |  |
| GNW_H7B0_SYSCFG_EXTICR4 | 0x14 | shadow | shadow |  |
| GNW_H7B0_SYSCFG_CCCSR | 0x20 | shadow | shadow |  |
| GNW_H7B0_SYSCFG_CCVR | 0x24 | shadow | shadow |  |
| GNW_H7B0_SYSCFG_CCCR | 0x28 | shadow | shadow |  |
| GNW_H7B0_SYSCFG_BRK_LOCKUPR | 0x118 | shadow | shadow |  |

Summary: 9 registers found. Write: 0 explicit / 9 shadow. Read: 0 explicit / 9 shadow.
